...
{
    internal OrderItem(OrderId orderId, ProcedureId procedureId, int quantity, decimal charge)
    {
    ...
    public decimal Charge { get; private set; } = default!; // exp: price per unit
}
